...
Result = pd.read_csv('wireless_channel_result1', names=['WiFi_Throughput', 'WiFi_Channel(Windows)', 'GUI_Channel', 'GUI_Mode','GUI_SSID', 'GUI_Region', 'WiFi_Mode_Manually', 'WiFi_Band', 'GUI_Security', 'WiFi_Security_Manually', 'Time'])
...
def store_result_to_excel(Result,WiFi_Band,WiFi_Mode,WiFi_Security,GUI_Security):
    for i in WiFi_Mode:
        ...
        #sheet = str(WiFi_Band) + '_' + str(i) + '_' + str(WiFi_Security)
